...
<div class="flex flex-wrap gap-y-10">
    ...
    >
        ...
        >
			<input type="hidden" name="openai_id" value="{{ $openai->id }}">
			@csrf
            <h3>
                {{ __('Source Video') }}
            </h3>
			...
			<div class="my-2 flex flex-col flex-wrap justify-between gap-3 md:flex-row">
				<select name="model" id="model" class="form-select w-full">
					...
					<option value="{{ \App\Domains\Entity\Enums\EntityEnum::FAST_ANIMATEDIFF_TURBO->value }}">{{ \App\Domains\Entity\Enums\EntityEnum::FAST_ANIMATEDIFF_TURBO->label() }}</option>
				</select>
			</div>

            <div id="prompt_input"  class="my-2 flex flex-col flex-wrap justify-between gap-3 md:flex-row hidden">
                <x-forms.input
            ...
            <div id="first_n_seconds_input" class="my-2 flex flex-col flex-wrap justify-between gap-3 md:flex-row hidden">
				<x-forms.input
					class:container="grow"
					id="first_n_seconds"
            ...
            <div id="scale_input" class="my-2 flex flex-col flex-wrap justify-between gap-3 md:flex-row">
				<x-forms.input
					class:container="grow"
					id="scale"
					label="{{ __('Scale') }}"
            ...
            <div id="num_inference_steps_input" class="hidden my-2 flex flex-col flex-wrap justify-between gap-3 md:flex-row">
				<x-forms.input
					class:container="grow"
					id="scale"
            ...
            <div id="select_every_nth_frame_input" class="hidden my-2 flex flex-col flex-wrap justify-between gap-3 md:flex-row">
				<x-forms.input
					class:container="grow"
					id="scale"
			...
			$.ajax({
				...
				success: function(res) {
					...
					if (res.status === 'finished') {
                        ...
                        $('#openai_generator_button').html('Generate');
